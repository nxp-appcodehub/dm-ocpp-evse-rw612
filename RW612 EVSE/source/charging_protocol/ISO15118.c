...
void EVSE_ISO15118_SetPaymentMethod(vehicle_auth_methods_t method)
{
...
void EV_ISO15118_GetVehicleData(vehicle_data_t *vehicle_data)
{
    ...
    vehicle_auth_methods_t auth_method = VehicleAuth_None;
...
vehicle_auth_methods_t EV_GetAuthMethod()
{
...
void EV_ISO15118_SetAuthMethod(vehicle_auth_methods_t auth_method)
{
